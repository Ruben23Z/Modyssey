...
function sendAuthEmail(
    ...
    // Subject em UTF-8 (encoded-word RFC 2047, esquema B) para evitar
    // problemas de acentos como "DisponÃ­vel" em vez de "Disponível"
    $headers .= encodeHeader('Subject', $subject);
